(function () {
  ...
  const initialStoreRows = [
    ["ALCOPOINT AZADLIQ", "Azadlıq prospekti 116, Bakı"],
    ["ALCOPOINT INQILAB", "Həsən Əliyev küçəsi 25, Bakı"],
    ["ALCOPOINT LIDER", "Akim Abbasov küçəsi 138-140, Bakı"],
    ["ALCOPOINT LİDO", "Atatürk prospekti 182a, Bakı"],
    ["ALCOPOINT MERDEKAN", "Sergey Yesenin küçəsi 78, Mərdəkan"],
    ["ALCOPOINT NEAPOL", "Neapol küçəsi 16/2, Bakı"],
    ["ALCOPOINT TEHSIL N.", "Gülarə Qədirbəyova küçəsi 3-17, Bakı"],
    ["ALCOPOINT 28 MAY", "28 May küçəsi 29, Bakı"],
    ["ALCOPOINT 6 PARALEL", "Murtuza Muxtarov küçəsi 179, Nizami, Bakı"],
    ["ALCOPOINT BADAMDAR", "Badamdar şosesi 40/1, Bakı"],
    ["ALCOPOINT BUZOVNA", "Aruz Mirzəyev küçəsi 8, Buzovna"],
    ["ALCOPOINT ELMLER", "Əbdürrəhim bəy Haqverdiyev küçəsi 99, Bakı"],
    ["ALCOPOINT H.ELIYEV", "Heydər Əliyev küçəsi 38, Bakı"],
    ["ALCOPOINT INQILAB 2", "Həsən Əliyev küçəsi 8-12, Bakı"],
    ["ALCOPOINT NIZAMI", "Nizami küçəsi 209-213, Bakı"],
    ["ALCOPOINT QIS PARKI", "Təbriz Xəlilbəyli küçəsi 43, Bakı"],
    ["ALCOPOINT QIS PARKI 2", "Füzuli küçəsi 39, Bakı"],
    ["ALCOPOINT BABEK", "Babək prospekti 424/1, Bakı"],
    ["ALCOPOINT 4MKR", "20 Yanvar küçəsi 191-193, Bakı"],
    ["ALCOPOINT MALACAN", "Rasul Rza küçəsi, Bakı 1003"],
    ["ALCOPOINT RUSLAN 93", "Qara Qarayev prospekti 8, Bakı"],
    ["ALCOPOINT PRAQA", "Qara Qarayev prospekti 39, Bakı"],
    ["ALCOPOINT ELIYAR E.", "Aliyar Əliyev küçəsi 56, Bakı"],
    ["ALCOPOINT NEAPOL 2", "Neapol küçəsi 136, Bakı"],
    ["ALCOPOINT BADAMDAR 2", "Badamdar şosesi 27/1, Bakı"],
    ["ALCOPOINT YASAMAL", "Murtuza Muxtarov küçəsi 179, Bakı"],
    ["ALCOPOINT TIBB", "Cəlil Məmmədquluzadə küçəsi, Məhəllə 998, Bakı"],
    ["ALCOPOINT AG SEHER", "Mərkəzi bulvar 2, Bakı"],
    ["ALCOPOINT ZOOPARK", "Kazım Kazımzadə küçəsi 800, Bakı"],
    ["ALCOPOINT AZADLIQ 2", "Akademik Mirəsədulla Mirqasımov küçəsi 10, Bakı"],
    ["ALCOPOINT QALA SHOPPİNG", "Xəzər rayonu, Qala, Mərdəkan şossesi, Bakı 1076"],
  ];
  ...
  const storePhones = [
    "+994 51 999 99 12", "+994 51 999 99 18", "+994 51 999 99 23", "+994 51 999 99 24",
    "+994 51 999 99 25", "+994 51 999 99 26", "+994 51 999 99 27", "+994 51 999 99 32",
    "+994 51 999 99 34", "+994 51 999 99 36", "+994 51 999 99 37", "+994 51 999 99 38",
    "+994 51 999 99 41", "+994 51 999 99 43", "+994 51 999 99 46", "+994 51 999 99 47",
    "+994 51 999 99 48", "+994 51 999 99 52", "+994 51 999 99 53", "+994 51 999 99 54",
    "+994 51 999 99 58", "+994 51 999 99 62", "+994 51 999 99 68", "+994 51 999 99 71",
    "+994 51 999 99 72", "+994 51 999 99 73", "+994 51 999 99 75", "+994 51 999 99 76",
    "+994 50 232 00 04", "+994 50 232 00 04", "+994 50 232 00 04",
  ];
  ...
  const initialStores = initialStoreRows.map(([name, address], index) => ({
    ...
    name,
    address,
    phone: storePhones[index] || "+994 50 232 00 04",
    hours: "09:00 - 01:00",
    mapUrl: "",
  ...
  async function login(username, password) {
    ...
    if (data.ok && data.token) localStorage.setItem(keys.auth, data.token);
